...
void* calc_runner1_NOTUSED(void*badhack1) {
...
int main(int argc, char**argv) {
  ...
  for(int y = 0; y < height; y++) {
    //printf("Creating thread....%d\n",y); // Dont delete this line
      int result = pthread_create( & tids[y] , NULL, calc_runner2, &y);
      if(result) quit("pthread_create failed");
      //SDL_Delay(5); // You might need a larger value to make it work on your machine            
  }
